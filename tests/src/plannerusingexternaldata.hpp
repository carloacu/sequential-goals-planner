#ifndef CONTEXTUALPLANNERGTESTS_PLANNERUSINGEXTERNALDATA_HPP
#define CONTEXTUALPLANNERGTESTS_PLANNERUSINGEXTERNALDATA_HPP
...
#endif // CONTEXTUALPLANNERGTESTS_PLANNERUSINGEXTERNALDATA_HPP
