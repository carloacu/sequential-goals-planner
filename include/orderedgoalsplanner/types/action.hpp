#ifndef INCLUDE_ORDEREDGOALSPLANNER_TYPES_ACTION_HPP
#define INCLUDE_ORDEREDGOALSPLANNER_TYPES_ACTION_HPP
...
struct ORDEREDGOALSPLANNER_API Action
{
  /**
...
#endif // INCLUDE_ORDEREDGOALSPLANNER_TYPES_ACTION_HPP
