#ifndef INCLUDE_ORDEREDGOALSPLANNER_FACTOPTIONAL_HPP
#define INCLUDE_ORDEREDGOALSPLANNER_FACTOPTIONAL_HPP
...
struct ORDEREDGOALSPLANNER_API FactOptional
{
  /**
...
#endif // INCLUDE_ORDEREDGOALSPLANNER_FACTOPTIONAL_HPP
