#ifndef INCLUDE_PRIORITIZEDGOALSPLANNER_SETOFFACTS_HPP
#define INCLUDE_PRIORITIZEDGOALSPLANNER_SETOFFACTS_HPP
...
struct PRIORITIZEDGOALSPLANNER_API SetOfFacts
{
  SetOfFacts();
...
#endif // INCLUDE_PRIORITIZEDGOALSPLANNER_SETOFFACTS_HPP
