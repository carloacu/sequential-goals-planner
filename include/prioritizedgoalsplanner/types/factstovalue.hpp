#ifndef INCLUDE_PRIORITIZEDGOALSPLANNER_FACTSTOVALUE_HPP
#define INCLUDE_PRIORITIZEDGOALSPLANNER_FACTSTOVALUE_HPP
...
struct PRIORITIZEDGOALSPLANNER_API FactsToValue
{
  FactsToValue();
