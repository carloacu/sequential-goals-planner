...
void printUsage() {
  std::cout << "Usage: contextualplanner -d <domain_file> -p <problem_file> [--verbose] [-o <output_plan_file>]" << std::endl;
  std::cout << "or" << std::endl;
  std::cout << "Usage: contextualplanner <domain_file> <problem_file> [--verbose] [-o <output_plan_file>]" << std::endl;
  std::cout << "or" << std::endl;
  std::cout << "Usage: contextualplanner --dp <directory_with_domain_pddl_and_problem_pddl_files_in_it> [--verbose] [-o <output_plan_file>]" << std::endl;
}
...
int main(int argc, char* argv[])
{
  ...
  if (!output_plan_file.empty())
  {
    ...
    file << "; Plan generated by contextualplanner.\n";
