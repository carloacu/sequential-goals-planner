#ifndef CONTEXTUALPLANNER_SRC_ALGO_CONVERTTOPARALLELPLAN_HPP
#define CONTEXTUALPLANNER_SRC_ALGO_CONVERTTOPARALLELPLAN_HPP
...
#endif // CONTEXTUALPLANNER_SRC_ALGO_CONVERTTOPARALLELPLAN_HPP
